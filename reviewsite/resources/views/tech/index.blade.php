<x-layouts.app>
    <div class="min-h-screen bg-[#151515]">
                ...
                <div class="max-w-6xl mx-auto">
                    ...
                    <nav class="mb-8">
                        <div class="flex items-center gap-2 text-sm font-['Inter']">
                            ...
                            <span class="text-[#E53E3E] font-medium">Tech</span>
                        </div>
                    </nav>
                        ...
                        <div class="lg:col-span-2">
                            <div class="mb-6">
                                ...
                                <p class="text-xl text-[#A1A1AA] leading-relaxed font-['Inter'] max-w-2xl">
                                    Explore our comprehensive tech library with detailed reviews of gaming hardware, accessories, and cutting-edge technology. 
                                    From consoles to controllers, headsets to keyboards.
                                </p>
                            </div>
                                ...
                                <div class="space-y-6">
                                    <div class="flex items-center justify-between">
                                        <div>
                                            ...
                                            <div class="text-sm text-[#A1A1AA] font-['Inter']">Total Products</div>
                                        </div>
        ...
        <div class="container mx-auto px-4 py-8">
            <form method="GET" action="{{ route('tech.index') }}" class="bg-[#27272A] rounded-lg shadow-md border border-[#3F3F46] overflow-hidden">
                <!-- Category Tabs -->
                    ...
                    <div class="flex gap-4">
                        <div class="flex-1">
                            <input 
                                type="text" 
                                name="search" 
                                placeholder="Search hardware, accessories, and reviews..." 
                ...
                @empty
                    <div class="relative bg-gradient-to-br from-[#27272A] to-[#1A1A1B] rounded-2xl p-16 text-center border border-[#3F3F46] shadow-2xl overflow-hidden">
                        ...
                        <div class="relative">
                            ...
                            <h3 class="text-2xl font-bold text-white mb-4 font-['Share_Tech_Mono']">No Tech Products Found</h3>
                            <p class="text-[#A1A1AA] font-['Inter'] text-lg max-w-md mx-auto">Try adjusting your search criteria or check back later for new tech products.</p>
                            <div class="mt-8">
                                <a href="{{ route('tech.index') }}" class="inline-flex items-center bg-gradient-to-r from-[#E53E3E] to-[#DC2626] text-white px-8 py-3 rounded-xl font-bold font-['Inter'] shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 transition-all duration-300">
